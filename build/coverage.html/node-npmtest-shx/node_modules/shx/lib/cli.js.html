...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-shx/node_modules/shx/lib/cli.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-shx/node_modules/shx/lib/cli.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-shx/node_modules/shx/lib/</a> &#187; cli.js</div>
</div>
<div class="body">
...
<span class="missing-if-branch" title="if path not taken" >I</span>if ((0, _config.shouldReadStdin)(parsedArgs._)) {
...
<span class="cstat-no" title="statement not covered" >      return chunks.push(data);</span>
    });
...
<span class="cstat-no" title="statement not covered" >      return run(chunks.join(''));</span>
    });
  })();
} else {
